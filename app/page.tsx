              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="text-xl text-zinc-400 mt-4">
                    매트 위에서 깨어나고, 세상으로 확장해나가자!
                  </p>
                  <p className="text-lg text-zinc-500">
                    요가 입문자와 중급자를 위한 요가 플랫폼
                  </p>
                </div>
              </div>
        ...
        >
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <div className="inline-block rounded-lg bg-red-900/20 px-3 py-1 text-sm text-red-500">
                  핵심 기능
                </div>
                ...
                <p className="max-w-[900px] text-zinc-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  수련 습관 형성을 돕고, 수련 기록과 주변 요가원 탐색까지
                  서포트합니다.
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-zinc-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                    ONMATOUT은 요가 수련을 기록하고 추적하는 것을 넘어, 당신의
                    요가 여정을 더 풍요롭게 만들어줍니다.
                  </p>
                </div>
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 py-12 md:grid-cols-3">
              <div className="flex flex-col items-center space-y-2 rounded-lg border border-zinc-800 bg-zinc-950 p-6">
                ...
                <p className="text-sm text-zinc-400 text-center">
                  300개의 아사나 카드로 다양한 요가 포즈와 그 효과에 대해
                  배우며, 온/오프라인에서 언제든 접근할 수 있습니다.
                </p>
              </div>
              <div className="flex flex-col items-center space-y-2 rounded-lg border border-zinc-800 bg-zinc-950 p-6">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[600px] text-zinc-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  곧 여러분을 찾아갑니다. 매트 위에서 깨어나고, 세상으로
                  확장해나가는 요가 여정을 함께 시작해요.
                </p>
              </div>
            </div>
          </div>
